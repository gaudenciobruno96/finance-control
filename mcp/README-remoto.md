...
Estado atual: **Projetos 1 e 2 implementados**. As dezessete ferramentas
...
| `historico_de_gastos` | "Quanto eu gastei com isso?" — o passado já pago, agregado por nome ou por categoria, nos últimos meses |
